...
var firefoxShim = {
  ...
  shimRemoveStream: function(window) {
    ...
    window.RTCPeerConnection.prototype.removeStream = function(stream) {
      var pc = this;
      utils_1.deprecated('removeStream', 'removeTrack');
...
var log = {
  blue: function blue(label) {
    ...
    return (_console = console).log.apply(_console, ['%c ' + label + ' ', 'background: dodgerblue; color: white'].concat(data));
  },
  red: function red(label) {
    var _console2;
    ...
    return (_console2 = console).log.apply(_console2, ['%c ' + label + ' ', 'background: red; color: white'].concat(data));
  },
  green: function green(label) {
    var _console3;
    ...
    return (_console3 = console).log.apply(_console3, ['%c ' + label + ' ', 'background: yellowgreen; color: white'].concat(data));
  }
};
