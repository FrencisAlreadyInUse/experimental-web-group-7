...
const ScreenWaiting = () => (
  <Screen name="waiting" className="around">
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="166.8px" height="100px">
      <path id="cone-01" className="beige logo-cone" d="M106.6,57.3c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
        ...
        z"/>
      <path id="cone-02" className="beige logo-cone" d="M136.7,32.7c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
        c-4.1,0.2-8.3,0.7-12.3,2c-3.1,1-7.4,2.8-7.4,6.6c0,0.8,0,4.1,0,5c0,4.3,6,6.1,9.3,6.9c4.4,1.1,9,1.5,13.5,1.5
        ...
        z"/>
      <path id="cone-03" className="beige logo-cone" d="M76.5,32.7c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
        c-4.1,0.2-8.3,0.7-12.3,2c-3.1,1-7.4,2.8-7.4,6.6c0,0.8,0,4.1,0,5c0,4.3,6,6.1,9.3,6.9c4.4,1.1,9,1.5,13.5,1.5
        ...
        z"/>
      <path id="cone-04" className="beige logo-cone" d="M166.8,8.1c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
        c-4.1,0.2-8.3,0.7-12.3,2c-3.1,1-7.4,2.8-7.4,6.6c0,0.8,0,4.1,0,5c0,4.3,6,6.1,9.3,6.9c4.4,1.1,9,1.5,13.5,1.5
      ...
      <path id="cone-05" className="beige logo-cone" d="M106.6,8.1c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
        c-4.1,0.2-8.3,0.7-12.3,2c-3.1,1-7.4,2.8-7.4,6.6c0,0.8,0,4.1,0,5c0,4.3,6,6.1,9.3,6.9c4.4,1.1,9,1.5,13.5,1.5
        ...
        z"/>
      <path id="cone-06" className="beige logo-cone" d="M46.4,8.1c0-1.8-1.6-3.2-3-4.1c-2.7-1.7-6-2.6-9.2-3.1c-4.8-0.9-9.7-1-14.5-0.8
